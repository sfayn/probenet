 ...
 *
 */
public class AdaptableFuzzySprayRouter extends EnergyAwareRouter {
	...
	public AdaptableFuzzySprayRouter(Settings s) throws IOException {
		super(s);
        FTCmax=0;
        MSmax=0;
	 ...
	 */
	protected AdaptableFuzzySprayRouter(AdaptableFuzzySprayRouter r) {
		super(r);
	...
	protected Tuple<Message, Connection> tryOtherMessages() {
		...
		for (Connection con : getConnections()) {
			...
			AdaptableFuzzySprayRouter othRouter = (AdaptableFuzzySprayRouter)other.getRouter();
	...
	public void changedConnection(Connection con) {
		if (con.isUp()) { // new connection
			if (con.isInitiator(getHost())) {
				...
				assert mRouter instanceof AdaptableFuzzySprayRouter : "AdaptableFuzzySprayRouter only works "+
				" with other routers of same type";
				AdaptableFuzzySprayRouter otherRouter = (AdaptableFuzzySprayRouter)mRouter;
	...
	@Override
	public AdaptableFuzzySprayRouter replicate() {
		return new AdaptableFuzzySprayRouter(this);
	}
}
