 ...
 *
 */
public class AdaptableFuzzySprayAndWaitRouter_drop_last extends EnergyAwareRouter {
	...
	public AdaptableFuzzySprayAndWaitRouter_drop_last(Settings s) throws IOException {
		super(s);
	...
	public void changedConnection(Connection con) {
		if (con.isUp()) { // new connection
			if (con.isInitiator(getHost())) {
				...
				assert mRouter instanceof AdaptableFuzzySprayAndWaitRouter_drop_last : "FuzzySprayAndWaitRouter only works "+
				" with other routers of same type";
				AdaptableFuzzySprayAndWaitRouter_drop_last otherRouter = (AdaptableFuzzySprayAndWaitRouter_drop_last)mRouter;
	...
	@Override
	public AdaptableFuzzySprayAndWaitRouter_drop_last replicate() {
		return new AdaptableFuzzySprayAndWaitRouter_drop_last(this);
	}
}
