 ...
 *
 */
public class AdaptableFuzzySprayAndWaitRouter_opposite1 extends EnergyAwareRouter {
		/** identifier for the logger file setting ({@value})*/
		public static final String NROF_COPIES = "nrofCopies";
		/** identifier for the binary-mode setting ({@value})*/
		public static final String BINARY_MODE = "binaryMode";
		/** SprayAndWait router's settings name space ({@value})*/
		public static final String FUZZYSPRAY_NS = "AdaptableFuzzySprayAndWaitRouter_opposite1";
	...
	public AdaptableFuzzySprayAndWaitRouter_opposite1(Settings s) throws IOException {
		super(s);
	 ...
	 */
	protected AdaptableFuzzySprayAndWaitRouter_opposite1(AdaptableFuzzySprayAndWaitRouter_opposite1 r) {
		super(r);
	...
	public void changedConnection(Connection con) {
		if (con.isUp()) { // new connection
			if (con.isInitiator(getHost())) {
				...
				assert mRouter instanceof AdaptableFuzzySprayAndWaitRouter_opposite1 : "FuzzySprayAndWaitRouter only works "+
				" with other routers of same type";
				AdaptableFuzzySprayAndWaitRouter_opposite1 otherRouter = (AdaptableFuzzySprayAndWaitRouter_opposite1)mRouter;
	...
	@Override
	public AdaptableFuzzySprayAndWaitRouter_opposite1 replicate() {
		return new AdaptableFuzzySprayAndWaitRouter_opposite1(this);
	}
}
