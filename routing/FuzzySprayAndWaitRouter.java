...
public class FuzzySprayAndWaitRouter extends ActiveRouter {
	 ...
	 */
	protected FuzzySprayAndWaitRouter(FuzzySprayAndWaitRouter r) {
		super(r);
	...
	public void changedConnection(Connection con) {
		if (con.isUp()) { // new connection
			if (con.isInitiator(getHost())) {
				...
				assert mRouter instanceof FuzzySprayAndWaitRouter : "FuzzySprayAndWaitRouter only works "+
				" with other routers of same type";
				FuzzySprayAndWaitRouter otherRouter = (FuzzySprayAndWaitRouter)mRouter;
	...
	public FuzzySprayAndWaitRouter replicate() {
		return new FuzzySprayAndWaitRouter(this);
	}
}
