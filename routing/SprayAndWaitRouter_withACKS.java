 ...
 *
 */
public class SprayAndWaitRouter_withACKS extends EnergyAwareRouter {
	...
	public SprayAndWaitRouter_withACKS(Settings s) {
		super(s);
	 ...
	 */
	protected SprayAndWaitRouter_withACKS(SprayAndWaitRouter_withACKS r) {
		super(r);
	...
	public void changedConnection(Connection con) {
		if (con.isUp()) { // new connection
			if (con.isInitiator(getHost())) {
				...
				assert mRouter instanceof SprayAndWaitRouter_withACKS : "SWwA only works "+
				" with other routers of same type";
				SprayAndWaitRouter_withACKS otherRouter = (SprayAndWaitRouter_withACKS)mRouter;
	...
	@Override
	public SprayAndWaitRouter_withACKS replicate() {
		return new SprayAndWaitRouter_withACKS(this);
	}
}
